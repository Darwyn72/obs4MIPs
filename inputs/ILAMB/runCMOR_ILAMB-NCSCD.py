...
#%% User provided input 
cmorTable = '../../Tables/obs4MIPs_Lmon.json' ; # Aday,Amon,Lmon,Omon,SImon,fx NOTE: No table exists for land annual mean data....

#EXAMPLES with command line input
# python -i runCMOR_ILAMB-NCSCD.py gpp NCSCD_input.json /home/users/obs4MIPs/ILAMB/ILAMB-data/NCSCD/in/gpp_mon_NCSCD_gn_xxx.nc # Need to check file names
